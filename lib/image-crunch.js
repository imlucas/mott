...
function findExecutables(what){
    what.forEach(function(tool){
        try{
            ...
            common.fatal(tool.executable + ' does not seem to be installed.');
            process.exit(1);
        }
    });
}
...
module.exports = function(grunt){
    grunt.registerTask('pngCrunch', function(){
                ...
                return sequence(pngTools.map(function(tool){
                    return function(){
                        ...
                        return common.exec(cmd).then(function(){
                            ...
                            newSizes[tool.name][p] = {'start': startingSize, 'end': stat.size};
    ...
    grunt.registerHelper('jpegCrunch', function(){
